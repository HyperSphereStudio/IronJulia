...
namespace IronJulia.Emit.ILEmitter;
...
public struct IlExprBuilder
{
    ...
    private static readonly MethodInfo
        GC_AllocateUnitialized_1 = typeof(GC).GetMethod("AllocateUninitializedArray`1"),
        Array_Empty_1 = typeof(Array).GetMethod("Empty`1"),
    ...
    public static implicit operator MethodInfo(IlExprBuilder b) => (MethodInfo)b.InternalMethod;
    public static implicit operator ConstructorBuilder(IlExprBuilder b) => (ConstructorBuilder)b.InternalMethod;
    public static implicit operator DynamicMethod(IlExprBuilder b) => (DynamicMethod)b.InternalMethod;
    ...
    public readonly struct ILConversionBuilder
    {
        ...
        public ILConversionBuilder Float(int byteSize)
        {
            ...
            {
                case 4:
                    _eb._il.Emit(Conv_R4);
                    break;
                case 8:
                    _eb._il.Emit(Conv_R8);
                    break;
        ...
        public void CastClass(System.Type t) => _eb._il.Emit(Castclass, t);
    }
    ...
    public readonly struct ILFunctionExprBuilder
    {
        ...
        public ILFunctionExprBuilder Invoke(IlExprBuilder fb, bool requiresConstructor = false,
            bool requiresMethod = false)
        {
            switch (fb.InternalMethod)
            {
                case MethodInfo mb when !requiresConstructor:
                    Invoke(mb);
                    break;
                case ConstructorInfo cb when !requiresMethod:
                    Invoke(cb);
                    break;
                default:
    ...
    public struct ILLoadExprBuilder
    {
        ...
        public ILLoadExprBuilder Token(System.Type t)
        {
        ...
        public ILLoadExprBuilder Type(System.Type t)
        {
            Token(t);
            _eb.Function.Invoke(Type_GetRuntimeType);
            return this;
        }

        public ILLoadExprBuilder Property(PropertyInfo p)
        {
            _eb.Function.Invoke(p.GetGetMethod());
            return this;
        }
        ...
        public void FromPointerInt(bool unsigned, int size)
        {
            ...
            {
                case 1:
                    _eb._il.Emit(unsigned ? Ldind_U1 : Ldind_I1);
                    break;
                case 2:
                    _eb._il.Emit(unsigned ? Ldind_U2 : Ldind_I2);
                    break;
                case 4:
                    _eb._il.Emit(unsigned ? Ldind_U4 : Ldind_I4);
                    break;
                case 8:
                    _eb._il.Emit(Ldind_I8);
                    break;
        ...
        public void FromPointerFloat(int size)
        {
            ...
            {
                case 4:
                    _eb._il.Emit(Ldind_R4);
                    break;
                case 8:
                    _eb._il.Emit(Ldind_R8);
                    break;
                default: throw new NotSupportedException();
            }
        }
    ...
    public struct ILStoreExprBuilder
    {
        ...
        public ILStoreExprBuilder Property(PropertyInfo p)
        {
            _eb.Function.Invoke(p.GetSetMethod());
            return this;
        }
        ...
        public void ToPointerFloat(int size)
        {
            ...
            {
                case 4:
                    _eb._il.Emit(Stind_R4);
                    break;
                case 8:
                    _eb._il.Emit(Stind_R8);
                    break;
                default: throw new NotSupportedException();
            }
        }
    ...
    public struct ILCreateExprBuilder
    {
        ...
        public LocalBuilder Local(System.Type t, bool pinned = false) => _eb._il.DeclareLocal(t, pinned);

        public LocalBuilder LocalAndStore(System.Type t)
        {
            var lb = Local(t);
            _eb.Store.Local(lb);
            return lb;
    ...
    public struct ILArrayExprBuilder
    {
        ...
        public ILArrayExprBuilder LoadElement(int i, System.Type t)
        {
            _eb.Load.Const(i);
            return LoadElement(t);
        }

        public ILArrayExprBuilder LoadElement(System.Type t)
        {
            _eb._il.Emit(Ldelem, t);
            return this;
        }

        public ILArrayExprBuilder StoreElement(System.Type t)
        {
        ...
        public ILArrayExprBuilder StoreElement(int i, System.Type t)
        {
            _eb.Load.Const(i);
            return StoreElement(t);
        }

        public ILArrayExprBuilder Create1d(System.Type elType, bool unInit = false, bool pinned = false)
        {
            if (unInit)
            {
                _eb.Load.Bool(pinned);
                _eb.Function.Invoke(GC_AllocateUnitialized_1.MakeGenericMethod(elType));
            }
        ...
        public ILArrayExprBuilder Create1d(System.Type elType, int size, bool unInit = false, bool pinned = false)
        {
            if (size == 0)
            {
                _eb.Function.Invoke(Array_Empty_1.MakeGenericMethod(elType));
            }
            else
            {
                _eb.Load.Const(size);
        ...
        public LocalBuilder Serialize1D<T, TE>(ISet<T> e, Action<T> perElementSerializer)
        {
            var en = e.GetEnumerator();
            var l = Serialize1D<TE>(..(e.Count - 1), i =>
            {
                en.MoveNext();
                perElementSerializer(en.Current);
            });
            en.Dispose();
            return l;
        }

        public LocalBuilder Serialize1D<T, TE>(IList<T> e, Action<T> perElementSerializer) =>
            Serialize1D<TE>(..(e.Count - 1), i => perElementSerializer(e[i]));

        public LocalBuilder Serialize1D<TE>(Range r, Action<int> perElementSerializer)
        {
            Create1d(typeof(TE), r.End.Value - r.Start.Value, true);
    ...
    public struct ILUnsafeExprBuilder
    {
        ...
        public void StackAlloc(System.Type t, int size)
        {
    ...
    public void Box(System.Type t) => _il.Emit(OpCodes.Box, t);
    public void Unbox(System.Type t, bool any = false) => _il.Emit(any ? Unbox_Any : OpCodes.Unbox, t);
    public void Constrained(GenericTypeParameterBuilder ty) => _il.Emit(OpCodes.Constrained, ty);
    ...
    public void DefineArg(int index, string name, ParameterAttributes attributes = ParameterAttributes.None)
    {
        ...
        switch (InternalMethod)
        {
            ...
            case ConstructorBuilder cb:
                ...
                break;
            case DynamicMethod mi:
                mi.DefineParameter(index, attributes, name);
                break;
        }
    }

    public void SetAttribute(CustomAttributeBuilder cab)
    {
        switch (InternalMethod)
        {
            case MethodBuilder mb:
