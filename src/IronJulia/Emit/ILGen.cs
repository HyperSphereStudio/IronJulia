...
public static class ILGen
{
    ...
    public static void EmitStoreArg(this ILGenerator il, int index)
    {
        Debug.Assert(index >= 0);
        Debug.Assert(index < ushort.MaxValue);
    ...
    /// </summary>
    public static void EmitLoadValueIndirect(this ILGenerator il, Type type)
    {
    ...
    /// </summary>
    public static void EmitStoreValueIndirect(this ILGenerator il, Type type)
    {
        Debug.Assert(type != null);
    ...
    public static void EmitLoadElement(this ILGenerator il, Type type)
    {
        Debug.Assert(type != null);
    ...
    public static void EmitFieldAddress(this ILGenerator il, FieldInfo fi)
    {
    ...
    public static void EmitFieldGet(this ILGenerator il, FieldInfo fi)
    {
        Debug.Assert(fi != null);
    ...
    public static void EmitFieldSet(this ILGenerator il, FieldInfo fi)
    {
        Debug.Assert(fi != null);
    ...
    public static void EmitNull(this ILGenerator il)
    {
    ...
    public static void EmitPrimitive(this ILGenerator il, bool value)
    {
        il.Emit(value ? OpCodes.Ldc_I4_1 : OpCodes.Ldc_I4_0);
    }

    public static void EmitPrimitive(this ILGenerator il, int value)
    {
        il.Emit(OpCodes.Ldc_I4, value);
    }

    public static void EmitPrimitive(this ILGenerator il, uint value)
    {
        il.EmitPrimitive(unchecked((int)value));
    }

    public static void EmitPrimitive(this ILGenerator il, long value)
    {
    ...
    public static void EmitPrimitive(this ILGenerator il, ulong value)
    {
        il.EmitPrimitive(unchecked((long)value));
    }

    public static void EmitPrimitive(this ILGenerator il, double value)
    {
        il.Emit(OpCodes.Ldc_R8, value);
    }

    public static void EmitPrimitive(this ILGenerator il, float value)
    {
    ...
    public static bool CanEmitILConstant(Type type) {
        var t = type.GetNonNullableType();
    ...
    // Linq does
    public static bool TryEmitConstant(this ILGenerator il, object? value, Type type, ILocalCache locals) {
        if (value == null)
        {
    ...
    public static bool TryEmitILConstant(this ILGenerator il, object value, Type type)
    {
        Debug.Assert(value != null);
        ...
        if (value is nint nvalue)
            return TryEmitILConstant(il, (long)nvalue, typeof(long));
            
        if(value is nuint uvalue)
            return TryEmitILConstant(il, (ulong) uvalue, typeof(ulong));
    ...
    public static void EmitConvertToType(this ILGenerator il, Type typeFrom, Type typeTo, bool isChecked,
                  ...
                  nnType.IsAssignableFrom(nnExprType))) // up cast
        {
            ...
            (typeFrom.IsArray &&
             typeTo.IsArray) // reference conversion from one array type to another via castclass
        {
            il.EmitCastToType(typeFrom, typeTo);
        }
        else
    ...
    public static void EmitCastToType(this ILGenerator il, Type typeFrom, Type typeTo)
    {
    ...
    public static void EmitNumericConversion(this ILGenerator il, Type typeFrom, Type typeTo, bool isChecked)
    {
    ...
    public static void EmitNullableToNullableConversion(this ILGenerator il, Type typeFrom, Type typeTo,
        bool isChecked, ILocalCache locals)
    {
    ...
    public static void EmitNonNullableToNullableConversion(this ILGenerator il, Type typeFrom, Type typeTo,
        bool isChecked, ILocalCache locals)
    {
        Debug.Assert(!typeFrom.IsNullableType());
        Debug.Assert(typeTo.IsNullableType());
    ...
    public static void EmitNullableToNonNullableConversion(this ILGenerator il, Type typeFrom, Type typeTo,
        bool isChecked, ILocalCache locals)
    {
        Debug.Assert(typeFrom.IsNullableType());
        Debug.Assert(!typeTo.IsNullableType());
    ...
    public static void EmitNullableToNonNullableStructConversion(this ILGenerator il, Type typeFrom, Type typeTo,
        bool isChecked, ILocalCache locals) {
        Debug.Assert(typeFrom.IsNullableType());
        Debug.Assert(!typeTo.IsNullableType());
        Debug.Assert(typeTo.IsValueType);
    ...
    public static void EmitNullableToReferenceConversion(this ILGenerator il, Type typeFrom)
    {
        Debug.Assert(typeFrom.IsNullableType());
    ...
    public static void EmitNullableConversion(this ILGenerator il, Type typeFrom, Type typeTo, bool isChecked,
        ILocalCache locals)
    {
        bool isTypeFromNullable = typeFrom.IsNullableType();
        bool isTypeToNullable = typeTo.IsNullableType();
    ...
    public static void EmitHasValue(this ILGenerator il, Type nullableType)
    {
        ...
        MethodInfo mi = (MethodInfo)nullableType.GetMemberWithSameMetadataDefinitionAs(Nullable_Getter_HasValue);
    ...
    public static void EmitGetValue(this ILGenerator il, Type nullableType)
    {
        ...
        MethodInfo mi = (MethodInfo)nullableType.GetMemberWithSameMetadataDefinitionAs(Nullable_Getter_Value);
        Debug.Assert(nullableType.IsValueType);
        il.Emit(OpCodes.Call, mi);
    }
    ...
    public static void EmitGetValueOrDefault(this ILGenerator il, Type nullableType)
    {
        ...
        MethodInfo mi = (MethodInfo)nullableType.GetMemberWithSameMetadataDefinitionAs(Nullable_GetValueOrDefault);
        Debug.Assert(nullableType.IsValueType);
        il.Emit(OpCodes.Call, mi);
    }
    ...
    /// </summary>
    public static void EmitArray<T>(this ILGenerator il, T[] items, ILocalCache locals)
    {
    ...
    /// </summary>
    public static void EmitArray(this ILGenerator il, Type elementType, int count)
    {
    ...
    public static void EmitArray(this ILGenerator il, Type arrayType) {
    ...
    /// </summary>
    public static void EmitDefault(this ILGenerator il, Type type, ILocalCache? locals)
    {
        switch (type.GetTypeCode())
        {
